-- ════════════════════════════════════════════════════════════════
-- Migration 011 FINAL — Add missing columns to reference tables
-- ════════════════════════════════════════════════════════════════
-- Only adds columns and seeds MISSING data (skips duplicates)
...
-- ════════════════════════════════════════════════════════════════
-- SEED DATA (only if missing — use ON CONFLICT on environment_name)
-- ════════════════════════════════════════════════════════════════
